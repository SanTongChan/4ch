...
extern void ADC_0_enter_DefaultMode_from_RESET(void) {
	...
	/*
	// ADC0MX (AMUX0 Positive Input Selection) = ADC0P14 (Select ADC0.14.)
	*/
...
extern void TIMER01_0_enter_DefaultMode_from_RESET(void) {
	...
	/*
	// TH0 (Timer 0 High Byte) = 0xB0
	*/
	TH0 = (0xB0 << TH0_TH0__SHIFT);
	// [TH0 - Timer 0 High Byte]$

	// $[TL0 - Timer 0 Low Byte]
	/*
	// TL0 (Timer 0 Low Byte) = 0x3F
	*/
	TL0 = (0x3F << TL0_TL0__SHIFT);
	// [TL0 - Timer 0 Low Byte]$
